# CM-Runtime-Level-Editor

I wanted to learn to make a runtime level editor a long time ago but i couldn't find a single good tutorial.
After searching in google for a long time i found some assets which could be used to make a runtime level editor.
so i downloaded them and mix them. Then i had to modify those codes for a long time according my needs. Finally I managed to finish it. Here it is
